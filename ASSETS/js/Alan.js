// ==========================================
// IN THE ZONE — Music Player: Alan Walker
// ==========================================
...
let dev_picks = [
    {
        img: '/01_singers/Photos/Alan/Faded.jpg',
        name: 'Faded',
        artist: 'Alan Walker',
        music: '/Songs/Alan/Faded.mp3'
    },
    {
        img: '/01_singers/Photos/Alan/Spectre.jpg',
        name: 'The Spectre',
        artist: 'Alan Walker',
        music: '/Songs/Alan/The Spectre.mp3'
    },
    {
        img: '/01_singers/Photos/Alan/Alone.jpg',
        name: 'Alone',
        artist: 'Alan Walker',
        music: '/Songs/Alan/Alone.mp3'
    },
    {
        img: '/01_singers/Photos/Alan/Darkside.jpg',
        name: 'Darkside',
        artist: 'Alan Walker',
        music: '/Songs/Alan/Darkside.mp3'
    },
    {
        img: '/01_singers/Photos/Alan/Different_world.jpeg',
        name: 'Different World',
        artist: 'Alan Walker',
        music: '/Songs/Alan/Different World.mp3'
    },
    {
        img: '/01_singers/Photos/Alan/On My Way.jpg',
        name: 'On My Way',
        artist: 'Alan Walker',
        music: '/Songs/Alan/On My Way.mp3'
    }
];
...
async function switchTab(tab) {
    ...
    if (tab === 'top') {
        ...
        if (top_20_list.length === 0) {
            ...
            await fetchTopSongs('Alan Walker');
        }
