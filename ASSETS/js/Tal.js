// ==========================================
// IN THE ZONE — Music Player: Talwiinder
// NOTE: Song files not yet added — using
//       Honey Singh audio as placeholders.
//       Replace paths when you add Talwiinder mp3s.
// ==========================================
...
let dev_picks = [
    ...
    {
        img: '/01_singers/Photos/Talw/Wishes.jpeg',
        name: 'Wishes',
        artist: 'Talwiinder',
    ...
    {
        img: '/01_singers/Photos/Talw/Funk Song.jpeg',
        name: 'Funk Song',
        artist: 'Talwiinder',
        music: '/Songs/Honey/Blue_Eyes.mp3'  // placeholder
    },
    {
        img: '/01_singers/Photos/Talw/You.png',
        name: 'You',
        artist: 'Talwiinder',
...
async function switchTab(tab) {
    ...
    if (tab === 'top') {
        ...
        if (top_20_list.length === 0) {
            await fetchTopSongs('Talwiinder');
        }
